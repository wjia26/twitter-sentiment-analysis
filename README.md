...
Check out the main file **"_twitter-sent.ipynb"** - has steps and instructions to pull data using tweepy and do sentiment analysis via NLTK.

Check out **"_WordCloudAnalysis.ipynb"** - for analysis on how to do a WordCloud using this data.
